      ...
      <main>
        ...
        <section id="section-1">
          <nav>
            ...
            <div className="nav-elem">
              <i style={{ color: "red" }} className="ri-arrow-right-s-line"></i>
              Our Showreel
            </div>
            <div className="nav-elem">
          ...
          <div className="bottom">
            ...
            <div className="right">
              <p>
                Dogstudio is a <br /> multidisciplinary <br />
                creative studio at the <br /> intersection <br />
                of art, design and <br /> technology.
              </p>
